...
L0/L1/L2	Block descriptor (large mapping)	Table descriptor (points
to next level) L3	        Reserved/fault	                    Page
descriptor (4KB page)
*/
...
#define PTE_SH_INNER                                                           \
  (3ULL << 8) // Memory is shared across all cores in the same cluster and their
