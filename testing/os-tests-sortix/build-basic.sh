...
OSTEST_SKIP_DIRS="pthread threads spawn semaphore sys_sem arpa_inet netinet_in net_if netdb sys_socket math complex fenv grp pwd utmpx aio libintl dlfcn fmtmsg fnmatch ftw glob iconv langinfo locale monetary nl_types mqueue ndbm sched search sys_ipc sys_msg sys_shm sys_resource sys_statvfs sys_times sys_utsname sys_uio syslog termios uchar wchar wctype wordexp devctl endian"
